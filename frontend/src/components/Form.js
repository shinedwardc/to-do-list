...
const Form = ({onSubmit, initialValues}) => {
    ...
    const handleFormSubmit = (e) => {
        ...
        if (inputs.title === '' || inputs.description === ''){
            alert('Please fill in at least one character for both title and description');
            return;
        }
            ...
            <form className = {styles.form} onSubmit = {handleFormSubmit}>
                <div className = {styles.questionnare}>
                    ...
                    <div className = {styles.tagForm}>
                        ...
                        <div>
                            <input type = "color" id = "colorInput" name = "color" value = {currentColor.toString()} onChange = {handleColorChange}/>
                            <label for = "colorInput"> Choose a color for the tag</label>
                        </div>
                        <Button onClick = {handleTagSubmit} type = "button">Add tag</Button>
                        <div>
                        {
